    ...
    return (
        <section className="recomend-body position-relative">
            <div className="sub-title">
                <span className="titleZh">閱讀話題</span>
                <br />
                <span className="titleEn">THEME</span>
            </div>
                            ...
                            <figure className='themeBook'>
                                ...
                                <figcaption>
                                    ...
                                    <p className="recomend-p">
                                        許多人都害怕拜託別人幫忙，然而，怕麻煩別人其實是不願意承認自己需要對方，也活生生阻礙了別人對自己的需要。偶爾的示弱，會讓你更有力量。許多人都害怕拜託別人幫忙，然而，怕麻煩別人其實是不願意承認自己需要對方，也活生生阻礙了別人對自己的需要。偶爾的示弱，會讓你更有力量。
                </p>
                                </figcaption>
                            </figure>
                        </li>
            ...
            <div className="right-corn position-absolute"></div>
